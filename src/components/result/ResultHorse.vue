...
<script setup>
import HorseRanking from './HorseRanking.vue'
import PTag from '../common/PTag.vue'
import HorseInformationAfterRace from './HorseInformationAfterRace.vue'

defineProps(['horseInformation', 'horseIndex', 'raceIndex'])
</script>
